...
**Example:**
<Code lang="jsson" code={`name = João@Silva  // ❌ @ is not allowed without quotes`} />

**Fix:**
<Code lang="jsson" code={`name = "João@Silva"  // ✅ Use quotes for special characters`} />
...
**Fix:**
<Code lang="jsson" code={`name = "João"  // ✅ Close the string
age = 25`} />
...
**Fix:**
<Code lang="jsson" code={`user {  // ✅ Add the assignment (or just put { on same line)
  name = João
}`} />
...
**Example:**
<Code lang="jsson" code={`colors = [ red, blue, green,, ]  // ❌ Double comma`} />

**Fix:**
<Code lang="jsson" code={`colors = [ red, blue, green ]  // ✅ Remove extra comma`} />
...
**Fix:**
<Code lang="jsson" code={`active = "true"  // ✅ Make it a string
...
**Problem:**
<Code lang="jsson" code={`title = Software Engineer  // ❌ Space without quotes`} />

**Solution:**
<Code lang="jsson" code={`title = "Software Engineer"  // ✅ Use quotes for spaces`} />
...
**Problem:**
<Code lang="jsson" code={`colors = [ red blue green ]  // ❌ Missing commas`} />

**Solution:**
<Code lang="jsson" code={`colors = [ red, blue, green ]  // ✅ Add commas`} />

### 4. Trailing Commas

**Problem:**
<Code lang="jsson" code={`colors = [ red, blue, green, ]  // ❌ Trailing comma`} />

**Solution:**
<Code lang="jsson" code={`colors = [ red, blue, green ]  // ✅ Remove trailing comma`} />
...
<Code lang="jsson" code={`name = "João'  // ❌ Mismatched quotes
